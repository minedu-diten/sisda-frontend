...
import { SisdaSidebarService } from './sidebar.service';
...
@Component({
    selector: 'sisda-sidebar',
    templateUrl: './sidebar.component.html',
    styleUrls: ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SisdaSidebarComponent implements OnInit, OnDestroy {
    @Input()
    name: string;
    ...
    ngOnInit(): void {
        this._sisdaConfigService.config
            ...
            .subscribe((config) => {
                this._sisdaConfig = config;
            });
        this._sisdaSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._sisdaSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('sisda-sidebar-overlay');
        if (this.invisibleOverlay) {
            this._backdrop.classList.add('sisda-sidebar-overlay-invisible');
        }
