...
import { SisdaPerfectScrollbarGeometry, SisdaPerfectScrollbarPosition } from './sisda-perfect-scrollbar.interfaces';

@Directive({
    selector: '[sisdaPerfectScrollbar]'
})
export class SisdaPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
    ...
    @Input()
    set sisdaPerfectScrollbarOptions(value) {
    ...
    get sisdaPerfectScrollbarOptions(): any {
        return this._options;
    }

    @Input('sisdaPerfectScrollbar')
    ...
    ngAfterViewInit(): void {
        ...
        if (this.sisdaPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.sisdaPerfectScrollbarOptions
        });
    ...
    geometry(prefix: string = 'scroll'): SisdaPerfectScrollbarGeometry {
        return new SisdaPerfectScrollbarGeometry(
    ...
    position(absolute: boolean = false): SisdaPerfectScrollbarPosition {
        if (!absolute && this.ps) {
            return new SisdaPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
