...
@Component({
    selector     : 'sigsda-widget',
    templateUrl  : './widget.component.html',
    styleUrls    : ['./widget.component.scss'],
    encapsulation: ViewEncapsulation.None
})

export class SigsdaWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(SigsdaWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<SigsdaWidgetToggleDirective>;
