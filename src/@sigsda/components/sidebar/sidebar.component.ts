...
import { SigsdaSidebarService } from './sidebar.service';
...
@Component({
    selector: 'sigsda-sidebar',
    templateUrl: './sidebar.component.html',
    styleUrls: ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class SigsdaSidebarComponent implements OnInit, OnDestroy {
    @Input()
    name: string;
    ...
    ngOnInit(): void {
        this._sigsdaConfigService.config
            ...
            .subscribe((config) => {
                this._sigsdaConfig = config;
            });
        this._sigsdaSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void {
        ...
        this._sigsdaSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void {
        ...
        this._backdrop.classList.add('sigsda-sidebar-overlay');
        if (this.invisibleOverlay) {
            this._backdrop.classList.add('sigsda-sidebar-overlay-invisible');
        }
