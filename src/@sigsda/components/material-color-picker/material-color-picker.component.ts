...
import { MatColors } from '@sigsda/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const FUSE_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => SigsdaMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'sigsda-material-color-picker',
...
export class SigsdaMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, sigsda-navy-700 etc.)
