...
import '@sigsda/components/highlight/prism-languages';

@Component({
    selector : 'sigsda-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class SigsdaHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using sigsda-highlight
        // component
