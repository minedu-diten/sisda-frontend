...
export class SigsdaPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy {
    ...
    @Input()
    set sigsdaPerfectScrollbarOptions(value) {
    ...
    get sigsdaPerfectScrollbarOptions(): any {
        return this._options;
    }

    @Input('sigsdaPerfectScrollbar')
    ...
    ngAfterViewInit(): void {
        ...
        if (this.sigsdaPerfectScrollbarOptions.updateOnRouteChange) {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.sigsdaPerfectScrollbarOptions
        });
    ...
    geometry(prefix: string = 'scroll'): SigsdaPerfectScrollbarGeometry {
        return new SigsdaPerfectScrollbarGeometry(
    ...
    position(absolute: boolean = false): SigsdaPerfectScrollbarPosition {
        if (!absolute && this.ps) {
            return new SigsdaPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
